"""
implementation of mulilayer perceptron using Theano
...
class MLP:
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        # The logisitc regression layer gets as input the hidden units
        # of the hidden layer
        ...
        # negative log lilelihood of the MLP is given by the negative
